...
from datapipelines.pidata.PIconnect.PIConsts import (
    BufferMode,
    CalculationBasis,
...
class PISeriesContainer(ABC):
    ...
    def summaries(
        ...
        # JB REMOVED THIS SECTION, WHICH PREVIOUSLY WORKED BY CREATING AND
        # JOINING A DATAFRAME. THIS IS INEFFICIENT.
        # df = DataFrame()
        # for summary in pivalues:
        #     key = SummaryType(summary.Key).name
        ...
        for summary in pivalues:
            ...
            out_timestamps.append(timestamps)
